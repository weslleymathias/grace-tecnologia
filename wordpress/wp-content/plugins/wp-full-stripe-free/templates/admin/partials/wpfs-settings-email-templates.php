...
<form class="wpfs-form" <?php $view->formAttributes(); ?>>
    ...
    <div class="wpfs-form__cols wpfs-form__cols--templates">
        <div class="wpfs-form__col">
            <div class="wpfs-list-title"><?php esc_html_e( 'Available templates:', 'wp-full-stripe-free' ); ?></div>
...
<script type="text/template" id="wpfs-email-template">
    ...
    <div id="wpfs-insert-token-dialog" class="wpfs-dialog-content js-insert-token-dialog" title="<?php esc_html_e( 'Insert token', 'wp-full-stripe-free' ); ?>">
        <div class="wpfs-dialog-token-list">
            <div class="wpfs-form-group">
                <input class="wpfs-form-control js-token-autocomplete" type="text" placeholder="<?php esc_html_e( 'Search token', 'wp-full-stripe-free' ); ?>">
            </div>
        </div>
    </div>
    <div class="wpfs-form-group">
        <label for="" class="wpfs-form-label wpfs-form-label--actions">
            ...
            <div class="wpfs-form-label__actions">
                <% if (isTestSendingSupported) { %><a class="wpfs-btn wpfs-btn-link js-send-email-test" href="#"><?php esc_html_e( 'Send a test', 'wp-full-stripe-free' ); ?></a><% } %>
                <a class="wpfs-btn wpfs-btn-link js-reset-template" href="#"><?php esc_html_e( 'Reset template', 'wp-full-stripe-free' ); ?></a>
...
<script type="text/template" id="wpfs-modal-reset-template">
    ...
    <div class="wpfs-dialog-content-actions">
        <button class="wpfs-btn wpfs-btn-danger js-reset-template-dialog"><?php esc_html_e( 'Reset template', 'wp-full-stripe-free'); ?></button>
        <button class="wpfs-btn wpfs-btn-text js-close-this-dialog"><?php esc_html_e( 'Keep template', 'wp-full-stripe-free' ); ?></button>
    </div>
</script>
<script type="text/template" id="wpfs-modal-reset-template-in-progress">
    <div class="wpfs-dialog-scrollable">
        <p class="wpfs-dialog-content-text"><?php esc_html_e('Restoring the default template bundled with the plugin', 'wp-full-stripe-free'); ?></p>
    </div>
    <div class="wpfs-dialog-content-actions">
        <button class="wpfs-btn wpfs-btn-danger wpfs-btn-danger--loader" disabled><?php esc_html_e('Reset template', 'wp-full-stripe-free'); ?></button>
    </div>
</script>
    ...
    <form data-wpfs-form-type="<?php echo MM_WPFS::FORM_TYPE_ADMIN_SEND_TEST_EMAIL; ?>" class="wpfs-send-test-email-form">
        <div class="wpfs-dialog-scrollable">
            <div class="wpfs-tags-input-wrapper js-tags-input">
                <input id="wpfs-test-email-addresses--<?php echo MM_WPFS::FORM_TYPE_ADMIN_SEND_TEST_EMAIL ?>" class="wpfs-tags-input" type="text" name="wpfs-test-email-addresses" placeholder="<?php esc_html_e('Add email addresses', 'wp-full-stripe-free'); ?>">
            </div>
            <div class="wpfs-typo-body wpfs-typo-body--sm"><?php esc_html_e('Use space to separate email addresses', 'wp-full-stripe-free'); ?></div>
        </div>
        <div class="wpfs-dialog-content-actions">
            <button class="wpfs-btn wpfs-btn-primary js-send-email-test-dialog"><?php esc_html_e('Send test', 'wp-full-stripe-free'); ?></button>
...
<script type="text/template" id="wpfs-modal-send-email-test-in-progress">
    <div class="wpfs-dialog-scrollable">
        <p class="wpfs-dialog-content-text"><?php esc_html_e('Sending email to the specified addresses', 'wp-full-stripe-free'); ?></p>
    </div>
    <div class="wpfs-dialog-content-actions">
        <button class="wpfs-btn wpfs-btn-danger wpfs-btn-danger--loader" disabled><?php esc_html_e('Send test', 'wp-full-stripe-free'); ?></button>
    </div>
</script>
