...
<form name="wpfs-search-subscriptions" action="<?php echo $pageUrl; ?>" method="post">
    <div class="wpfs-page-controls">
        ...
        <div class="wpfs-ui wpfs-form-select wpfs-page-controls__control wpfs-page-controls__control--w200">
            <select class="js-selectmenu js-subscriptions-status-filter" name="<?php echo MM_WPFS_Admin_Menu::PARAM_NAME_SUBSCRIPTIONS_STATUS_FILTER ?>" id="status" data-selectmenu-prefix="<?php _e( "Status: ", 'wp-full-stripe-free' ); ?>">
                <option value="all" <?php echo $statusFilter === MM_WPFS_Admin_Menu::PARAM_VALUE_SUBSCRIPTION_STATUS_ALL ? 'selected': ''; ?>><?php _e( 'All', 'wp-full-stripe-free'); ?></option>
                <?php
        ...
        <div class="wpfs-ui wpfs-form-select wpfs-page-controls__control wpfs-page-controls__control--w200">
            <select class="js-selectmenu js-subscriptions-mode-filter" name="<?php echo MM_WPFS_Admin_Menu::PARAM_NAME_SUBSCRIPTIONS_MODE_FILTER ?>" id="mode" data-selectmenu-prefix="<?php _e( "Mode: ", 'wp-full-stripe-free' ); ?>">
...
<script type="text/template" id="wpfs-side-pane-subscription-details">
    <div class="wpfs-side-pane" data-db-id="<%- id %>" data-stripe-id="<%- subscriptionId %>">
        <div class="wpfs-side-pane__head">
            <div class="wpfs-side-pane__title"><?php _e( 'Subscription details', 'wp-full-stripe-free' ); ?></div>
        ...
        <div class="wpfs-side-pane-item">
            ...
            <div class="wpfs-side-pane-item__actions">
                ...
                <div class="wpfs-tooltip-content" data-tooltip-id="delete-subscription-tooltip">
                    <div class="wpfs-info-tooltip"><?php _e( 'Delete subscription', 'wp-full-stripe-free' ); ?></div>
                </div>
            </div>
        </div>
        <div class="wpfs-side-pane-list">
            <div class="wpfs-side-pane-list__title"><?php _e( 'Subscription', 'wp-full-stripe-free' ); ?></div>
            <ul class="wpfs-side-pane-list__list">
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Id:', 'wp-full-stripe-free' ); ?> <a class="wpfs-btn wpfs-btn-link" href="<%- subscriptionUrl %>" target="_blank"><%- subscriptionId %></a>
                </li>
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Product:', 'wp-full-stripe-free' ); ?> <span class="wpfs-side-pane-list__highlight"><%- productName %></span>
                </li>
                <li class="wpfs-side-pane-list__item">
                ...
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Status:', 'wp-full-stripe-free' ); ?> <span class="wpfs-side-pane-list__highlight"><%- localizedSubscriptionStatus %></span>
                </li>
                <li class="wpfs-side-pane-list__item">
                ...
                <% if ( coupon != null ) { %>
                <li class="wpfs-side-pane-list__item">
                    <?php _e( 'Coupon:', 'wp-full-stripe-free' ); ?> <span class="wpfs-side-pane-list__highlight"><%- coupon %></span>
                </li>
                <% } %>
            </ul>
